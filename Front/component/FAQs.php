...
<section class="justify-content-center" style="padding-bottom: 5rem;">
    ...
    <div class="accordion" id="accordionPanelsStayOpenExample">
      <div class="accordion-item">
        ...
        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne" data-bs-parent="#accordionPanelsStayOpenExample">
          <div class="accordion-body">
            Todos nuestros proyectos son de parcelas de 5.000 m2 o más, por lo tanto la subdivisión es aprobada por el Servicio Agrícola Ganadero y posteriormente el Servicio de Impuestos Internos le asigna un Pre-Rol correspondiente a cada parcela.
          </div>
        </div>
      </div>
      <div class="accordion-item">
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="panelsStayOpen-headingFour">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFour" aria-expanded="false" aria-controls="panelsStayOpen-collapseFour">
            ¿Qué significa que las parcelas tengan Rol Propio?
          </button>
        </h2>
      ...
      <div class="accordion-item">
        ...
        <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingSix" data-bs-parent="#accordionPanelsStayOpenExample">
          <div class="accordion-body">
            Se refiere a los distintos medios con que el cliente cuenta para abastecerse de este recurso, como por ejemplo, paneles solares, los postes de luz más cercanos al proyecto.
          </div>
        </div>
      </div>
      <div class="accordion-item">
